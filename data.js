...
const BODIES = [
  ...
  },
  {
    ...
    a_AU: 2.7658,
    eccentricity: 0.0785,
    orbital_velocity: 17.9,
    orbital_period: "4.6 años",
    rotation_period: "9h 4m",
    axial_tilt: 4,
    mean_temp_C: -105,
    moons: 0,
    color: 0x9a8f80,
    fact: "El mayor objeto del cinturon de asteroides y el unico planeta enano del sistema solar interior. Podria esconder agua bajo su superficie y tiene manchas brillantes de sal en el crater Occator."
  },
  {
    id: "pluton",
    name: "Plutón",
    ...
    a_AU: 39.482,
    eccentricity: 0.2488,
    orbital_velocity: 4.74,
    orbital_period: "248 años",
    rotation_period: "6.4 dias (retrogrado)",
    axial_tilt: 122.5,
    mean_temp_C: -229,
    moons: 5,
    satellites: [
      { id: "caronte", name: "Caronte", radius_km: 606, a_km: 19591, period_days: 6.387, gravity: 0.288, mass_kg: 1.586e21, color: 0xb8a890, fact: "La mayor luna de Pluton, casi la mitad de su tamaño. Ambos giran sincronizados mostrandose siempre la misma cara: son casi un planeta doble." },
      { id: "nix", name: "Nix", radius_km: 25, a_km: 48694, period_days: 24.85, color: 0xa8a29a, fact: "Pequeña luna de forma irregular que rota de manera caotica." },
      { id: "hidra", name: "Hidra", radius_km: 25, a_km: 64738, period_days: 38.20, color: 0xa8a29a, fact: "La luna mas exterior conocida de Pluton, muy reflectante por su hielo de agua." }
    ],
    color: 0xc9b8a0,
    fact: "Fue el noveno planeta hasta 2006. Tiene montañas de hielo y una gran llanura de nitrogeno con forma de corazon (Sputnik Planitia). Su luna Caronte es tan grande que ambos giran en torno a un punto comun."
  },
  {
    id: "haumea",
    name: "Haumea",
    ...
    a_AU: 43.22,
    eccentricity: 0.191,
    orbital_velocity: 4.53,
    orbital_period: "284 años",
    rotation_period: "3.9 h",
    axial_tilt: 0,
    mean_temp_C: -241,
    moons: 2,
    satellites: [
      { id: "hiiaka", name: "Hi'iaka", radius_km: 160, a_km: 49880, period_days: 49.5, color: 0xd0cabf, fact: "La mayor luna de Haumea; probablemente un fragmento desprendido por un gran impacto." },
      { id: "namaka", name: "Namaka", radius_km: 85, a_km: 25657, period_days: 18.3, color: 0xc8c2b8, fact: "La luna interior de Haumea, en una orbita muy inclinada." }
    ],
    color: 0xd8d2c8,
    fact: "Tiene forma de balon de rugby por su rapidisima rotacion (menos de 4 horas, la mas rapida de un cuerpo grande). Posee anillos y dos lunas."
  },
  {
    id: "makemake",
    name: "Makemake",
    ...
    a_AU: 45.43,
    eccentricity: 0.159,
    orbital_velocity: 4.4,
    orbital_period: "306 años",
    rotation_period: "22.5 h",
    axial_tilt: 0,
    mean_temp_C: -243,
    moons: 1,
    satellites: [
      { id: "mk2", name: "MK 2", radius_km: 87, a_km: 21100, period_days: 12.4, color: 0x5a5048, fact: "La unica luna conocida de Makemake (apodada MK2), muy oscura, descubierta en 2016." }
    ],
    color: 0xb86a4a,
    fact: "Uno de los objetos mas brillantes del cinturon de Kuiper. Su nombre viene del dios creador del pueblo rapanui de la Isla de Pascua."
  },
  {
    id: "eris",
    name: "Eris",
    ...
    a_AU: 67.78,
    eccentricity: 0.4418,
    orbital_velocity: 3.4,
    orbital_period: "558 años",
    rotation_period: "25.9 h",
    axial_tilt: 78,
    mean_temp_C: -243,
    moons: 1,
    satellites: [
      { id: "disnomia", name: "Disnomia", radius_km: 350, a_km: 37460, period_days: 15.79, color: 0x8a8278, fact: "La unica luna de Eris. Gracias a ella se pudo medir con precision la masa de Eris." }
    ],
    color: 0xd9d2c4,
    fact: "Casi del tamaño de Pluton pero mas masivo. Su descubrimiento en 2005 hizo que se creara la categoria de 'planeta enano' y que Pluton dejara de ser planeta."
  }
];
